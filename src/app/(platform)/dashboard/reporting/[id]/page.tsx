        ...
        <Card className="bg-white border-slate-200/60 shadow-sm rounded-3xl p-8 lg:p-12 mb-6 relative overflow-hidden print:break-inside-avoid">
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-white text-xs font-bold uppercase tracking-wider ${campaign.status === 'FINISHED' ? 'bg-[#10b981]' : 'bg-blue-500'}`}>
                {campaign.status === 'FINISHED' ? 'Finished' : 'Active'}
              </div>
            </div>
